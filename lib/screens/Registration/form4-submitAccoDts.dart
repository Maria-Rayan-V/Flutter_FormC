...
class SubmitAccoDts extends StatefulWidget {
  AccomodatorModel? data = AccomodatorModel();
  SubmitAccoDts({Key? key, @required this.data}) : super(key: key);

  @override
  State<SubmitAccoDts> createState() => _SubmitAccoDtsState();
}

class _SubmitAccoDtsState extends State<SubmitAccoDts> {
  ...
  next() {
    if (_fbKey.currentState!.saveAndValidate()) {
      stepsWizard!.createState().moveToRegnScreen("5", context);
  ...
  void initState() {
    ...
    if (widget.data != null) {
      ...
      //print('formCC Existing :$existingAccoDts');
    }
    setState(() {
      //  page1 = widget.data;
      stepsWizard = new RegnWizard(currentPageNo: "4");
    });
