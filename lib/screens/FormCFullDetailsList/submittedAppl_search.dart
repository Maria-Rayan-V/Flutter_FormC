...
import 'package:formc_showcase/screens/FormCFullDetailsList/formCDetailsList.dart';

class SubmittedApplicationSearch extends StatefulWidget {
  // const SubmittedApplicationSearch({ Key? key }) : super(key: key);

  @override
  _SubmittedApplicationSearchState createState() =>
      _SubmittedApplicationSearchState();
}

class _SubmittedApplicationSearchState
    extends State<SubmittedApplicationSearch> {
  ...
  Future processPartialData(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              FormCDetailListScreen(passportNumber, nationality)),
    );
